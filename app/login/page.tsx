...
const LoginPage = () => {
    ...
    return (
        <section className="w-full h-[20rem] flex justify-center items-center flex-col">
            ...
            <form className="w-[20rem] bg-blue-300 p-2 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                <div className="w-full">
                    <label htmlFor="email" className='py-2 text-sm'>Email</label>

                    <input type="email" className="input input-bordered w-full max-w-xs" {...register("email")} />
                </div>
                <div className="w-full">
                    <label htmlFor="password" className='py-2 text-sm'>Password</label>
